    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stage', models.IntegerField(blank=True, choices=[(0, 'No DR'), (1, 'Mild'), (2, 'Moderate'), (3, 'Severe'), (4, 'Proliferative DR')], null=True)),
                ...
                ('analyzed_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='analyzed_images', to=settings.AUTH_USER_MODEL)),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='retina_images', to='app.patient')),
            ],
        ),
    ]
